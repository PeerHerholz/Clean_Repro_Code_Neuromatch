...
2. Download the materials in this repository via [this link](https://github.com/PeerHerholz/Clean_Repro_Code_Neuromatch/archive/refs/heads/main.zip) and unzip them to directory you just created, e.g. `Desktop/Clean_Repro_Code_Neuromatch`.
3. Navigate to the [`environment.yml`](https://github.com/PeerHerholz/Clean_Repro_Code_Neuromatch/blob/main/environment.yml).
...
1. Create a directory dedicated only for work before and during the school, e.g. `Desktop/Clean_Repro_Code_Neuromatch`. 
2. Download the materials in this repository via [this link](https://github.com/PeerHerholz/Clean_Repro_Code_Neuromatch/archive/refs/heads/main.zip) and unzip them to directory you just created, e.g. `Desktop/Clean_Repro_Code_Neuromatch`.
3. Navigate to the [`requirements.txt`](https://github.com/PeerHerholz/Clean_Repro_Code_Neuromatch/blob/main/requirements.txt) file.
